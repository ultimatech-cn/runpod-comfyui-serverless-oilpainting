...
| `qwen_3_8b.safetensors` | `qwen_3_8b.safetensors` | `clip` | `clip` | `https://huggingface.co/Comfy-Org/vae-text-encorder-for-flux-klein-9b/resolve/main/split_files/text_encoders/qwen_3_8b.safetensors` | verified | portrait |
...
| `flux-2-klein-9b-nvfp4.safetensors` | `flux-2-klein-9b-nvfp4.safetensors` | `unet` | `unet` | `https://huggingface.co/black-forest-labs/FLUX.2-klein-9b-nvfp4/resolve/main/flux-2-klein-9b-nvfp4.safetensors` | verified | portrait |
